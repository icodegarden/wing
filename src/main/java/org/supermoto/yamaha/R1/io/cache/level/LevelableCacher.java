...
public class LevelableCacher implements Cacher {
	 ...
	 * <p>
	 * 当removed 不是 null
	 * 时，如果是DistributedCacher类型则执行。原因：{@link org.supermoto.yamaha.R1.io.cache.level.GetOfUpgradeStrategy#UpgradeGtMinAvg}
	 * 中 {@link org.supermoto.yamaha.R1.io.cache.distribution.DistributedCacher} 不会删除
	 */
	@Override
